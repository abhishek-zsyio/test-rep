...
hl.bind("CTRL + ALT + W", hl.dsp.exec_cmd("killall ags || ags run --gtk 3"))
hl.bind(mainMod .. " + A", hl.dsp.exec_cmd("waypaper"))
hl.bind(mainMod .. " + N", hl.dsp.exec_cmd("touch ${XDG_RUNTIME_DIR:-/run/user/1000}/ags_sidepanel_toggle"))
