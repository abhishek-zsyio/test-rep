-- Hyprland Native Lua Configuration (Hyprland 0.55+)

-- Sourcing modular configurations
...
-- AGS layer rules for blur
hl.layer_rule({ match = { namespace = "ags-bar" }, blur = true })
hl.layer_rule({ match = { namespace = "ags-control-center" }, blur = true })
hl.layer_rule({ match = { namespace = "ags-notifications" }, blur = true })
hl.layer_rule({ match = { namespace = "ags-dock" }, blur = true })
hl.layer_rule({ match = { namespace = "ags-overview" }, blur = true })
hl.layer_rule({ match = { namespace = "ags-lockscreen" }, blur = true })
hl.layer_rule({ match = { namespace = "ags-spotlight" }, blur = true })
