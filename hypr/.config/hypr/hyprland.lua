...
hl.layer_rule({ match = { namespace = "ags-bar" }, blur = true, ignore_alpha = 0.0 })
hl.layer_rule({ match = { namespace = "ags-control-center" }, blur = true, ignore_alpha = 0.0 })
hl.layer_rule({ match = { namespace = "ags-notifications" }, blur = true, ignore_alpha = 0.0 })
hl.layer_rule({ match = { namespace = "ags-dock" }, blur = true, ignore_alpha = 0.0 })
hl.layer_rule({ match = { namespace = "ags-overview" }, blur = true, ignore_alpha = 0.0 })
hl.layer_rule({ match = { namespace = "ags-lockscreen" }, blur = true, ignore_alpha = 0.0 })
hl.layer_rule({ match = { namespace = "ags-spotlight" }, blur = true, ignore_alpha = 0.0 })
