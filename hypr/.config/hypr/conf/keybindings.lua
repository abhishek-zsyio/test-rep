...
-- AGS Shell Toggles
hl.bind(mainMod .. " + C", hl.dsp.exec_cmd("ags request control-center toggle"))
hl.bind(mainMod .. " + UP", hl.dsp.exec_cmd("ags request overview toggle"))
hl.bind(mainMod .. " + SHIFT + T", hl.dsp.exec_cmd("ags request theme-picker toggle"))
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd("ags request screenshot toggle"))
